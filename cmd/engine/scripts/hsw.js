...
function getRandomNumberFromList(numberList) {
...
function _f99() {
    w = getRandomNumber(800, 3400)
    h = getRandomNumber(800, 3400)

    w1 = w - getRandomNumber(50, 300)
    h1 = h - getRandomNumber(50, 300)
...
function _687() {
    return [
        `5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${chromev}.0.0.0 Safari/537.36`,
        `Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${chromev}.0.0.0 Safari/537.36`,
        getRandomNumberFromList([2, 4, 6, 8, 12, 16]),
        getRandomNumberFromList([2, 4, 8, 16]),
        "fr-FR",
        [
            "fr-FR",
            "fr",
        ...
        null,
        [
            `Google Chrome ${chromev}`,
            `Not;A=Brand ${getRandomNumberFromList([8, 24, 99])}`,
            `Chromium ${chromev}`
        ],
        false,
        "Windows",
...
function _845() {
    return getRandomNumber(7000, 9000)
}

function _701() {
    return getRandomNumber(700, 2000)
}
            ...
            C = function () {
                ...
                try {
                    ...
                    if (dump[fp.fp_id] !== undefined) {
                        if (typeof dump[fp.fp_id] === 'function') {
