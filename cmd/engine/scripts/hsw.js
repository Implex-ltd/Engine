...
var hsw = function () {
    ...
    function appendJsonToMemory(pp) {
        ...
        const to_inject = new TextEncoder().encode(JSON.stringify(pp));
    ...
    var yI = Object.freeze({
        ...
        inject: function (ptr, len) {
            ...
            try {
                ...
                let n = JSON.parse(`${d1}${decodedString.split(d1)[1].split(d2)[0]}${d2}`)
                console.log(n)
                ...
                let base_payload = {
                    ...
                    "components": {
                        ...
                        "parent_win_hash": null,
                        "webrtc_hash": "-1",
                        "performance_hash": "2372271609278715010",
                        "unique_keys": null,
                        "inv_unique_keys": null,
                        "features": {
                    ...
                    "fingerprint_events": [
                        ...
                        [
                            107,
                            "[3440,1440,3440,1392,24,24,false,0,1,2630,1399,true,true,true,false]"
                        ],
                        [
                            302,
                        ...
                        [
                            1403,
                            "[\"kMLSkdTrmB=OFcTp2A6Z\",\"15\",\"a\",\"TUNLARHBYBOXS\"]"
                        ],
                        [
                            3504,
                            "1695973573693.2"
                        ...
                        [
                            3501,
                            "[[\"navigation:newassets.hcaptcha.com\",0.10000000149011612,3.600000001490116],[\"script:newassets.hcaptcha.com\",0.20000000298023224,3.7000000029802322],[\"xmlhttprequest:hcaptcha.com\",0,26.200000002980232]]"
                        ],
                        [
                            3503,
                            "0.15000000223517418"
                        ...
                        [
                            407,
                            "[[\"loadTimes\",\"csi\",\"app\"],35,34,null,false,false,true,37,true,true,true,true,true,[\"Raven\",\"_sharedLibs\",\"hsw\"],[[\"getElementsByClassName\",[]],[\"getElementById\",[]],[\"querySelector\",[]],[\"querySelectorAll\",[]]],[],true]"
                        ],
                        [
                            412,
                        ...
                        [
                            2420,
                            "[[\"mLwiTJRlxeXz3BOGlRT50ULlCMYUYU41\",\"a\",\"12\",\"PZQYPGBIYXOSQ\"],[\"ml40ci9WBknjtXEdmYUCRzbjmlmdm2admYUiQEhEmYUsUvbVei12BwItJyZ0Uon1swItJOglRt50ULnkmlajmlSEWRZ1t=40moFtmpajmlO3yfVzxwmkmlajmly2yfVzxwaj\",\"a\",\"27\",\"BTDMSOANAXYAX\"]]"
                        ],
                        [
                            2403,
                            "[\"Google Inc. (NVIDIA)\",\"ANGLE (NVIDIA, NVIDIA GeForce RTX 3060 Ti Direct3D11 vs_5_0 ps_5_0, D3D11)\"]"
        ...
        getPtr: function () {
            console.log('get jptr')
            return jptr
        },
        getLen: function () {
            console.log('get jlen')
            return jlen
        },
