    ...
    function II(A) {
        ...
        switch (g) {
            ...
            case 52:
                ...
                break
            case 114:
                var randomNumbers = Math.random() * (40- 30) + 30
                bg[114] = randomNumbers.toFixed(15)
                break
            case 113:
                bg[113] = ['default', 'prompt'] 
                break
            /*case 112:
                the_real = ["granted","TypeError","TypeError","granted","granted","TypeError","prompt","TypeError","prompt","granted","TypeError","prompt","TypeError","prompt","granted","prompt","granted","prompt","granted","TypeError","prompt","granted","denied","prompt","NotSupportedError","granted","TypeError","TypeError","TypeError","prompt"]

                for (let i = the_real.length - 1; i > 0; i--) {
                    const j = Math.floor(Math.random() * (i + 1));
                    [the_real[i], the_real[j]] = [the_real[j], the_real[i]];
                  }

                bg[112] = the_real // ça peut faire flag
           ...
           /* case 61:
            ...
            case 55: 
                ...
                break
           /* case 92:
                bg[92] = [(0.1 + Math.random() * 0.8).toFixed(16), 30] // jsp mais je pense performance (deja spoof) 
                break*/
