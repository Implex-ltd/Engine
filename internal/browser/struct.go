...
var (
	...
	HCAPTCHA_FRAME = `//iframe[contains(@title,'Widget contenant une case à cocher pour le défi de sécurité hCaptcha')]`//iframe[contains(@title,'Widget containing checkbox for hCaptcha security challenge')]`
)
